...
typedef struct {
    ...
    osMessageQueueId_t send_op_end_queue;
    osMessageQueueId_t recv_op_begin_queue;
    osMessageQueueId_t recv_op_end_queue;
...
bool task_comm_put_used_send_buffer(task_comm_info_t *task_comm_info, g3_msg_ids_t msg_id, uint8_t cmd_id,
                                    void * const buff, size_t size, uint32_t wait_time);
